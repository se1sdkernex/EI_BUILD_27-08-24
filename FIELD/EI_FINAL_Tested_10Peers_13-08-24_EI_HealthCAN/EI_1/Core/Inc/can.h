...
enum enumCanId
{
	GPS_TIME_PKT=0x103,
	GPS2_TIME_PKT=0x109,
	EI_PROCESS_DATA=0x119, /*4 */

	EI_PROCESS_DATA2 = 0x1F0,
	EI_PROCESS_DATA3 = 0x1F1,

	EiPC_1_HEALTH = 0x1F2, /* */
	EiPC_2_HEALTH = 0x1F3, /* */
	COMBINE_EiPC_HEALTH = 0x1F4,

	EiPC_1_HEALTH2 = 0x1F5, /* */
	EiPC_2_HEALTH2 = 0x1F6, /* */
	COMBINE_EiPC_HEALTH2 = 0x1F7,

	EiPC_1_HEALTH3 = 0x1F8, /* */
	EiPC_2_HEALTH3 = 0x1F9, /* */
	COMBINE_EiPC_HEALTH3 = 0x1FA,


	EI_1_SELF_SHARING=0x201,
	EI_2_SELF_SHARING=0x202,
	SEND_VITAL_MSG_1=0x203,
	SEND_VITAL_MSG_2=0x204,
	CAN_FAULT_INJECTION=0x205,
	LAST_RCV_MSGS_DIFF_2=0x206,
	EIPC1_RELAYS_2_OTHER=0x207,
	EIPC2_RELAYS_2_OTHER=0x208,
	MAXCANID
};
